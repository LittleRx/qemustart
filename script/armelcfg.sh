...
spawn qemu-system-arm -M $RUNTIME_BOARDB -kernel ./$structure/$RUNTIME_KERNEL -initrd ./$structure/$RUNTIME_INITRD -hda ./$structure/$RUNTIME_FQCOW2 -append root=/dev/sda1 -net nic -net tap,ifname=tap0,script=no,downscript=no -nographic
